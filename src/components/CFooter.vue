          ...
          <div class="col-12 col-md-6 col-lg-3">
            ...
            <div class="socials">
              ...
              <div class="footer-social">
                <a href="#" target="_blank"
                  ><i class="fa fa-instagram"></i>اینستاگرام تاپ کالا</a
                >
              </div>
            </div>
          </div>
      ...
      <div class="info">
        <div class="row">
          ...
          <div class="col-12 col-lg-4 text-center">
            <a href="#" target="_blank"
              ><img src="assets/img/bazzar.png" width="159" height="48" alt=""
            /></a>
            <a href="#" target="_blank"
              ><img src="assets/img/sibapp.png" width="159" height="48" alt=""
            /></a>
          </div>
        </div>
      </div>
