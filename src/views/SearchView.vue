              ...
              <div class="collapse show" id="collapseExample1">
                ...
                <div class="filter-option">
                  <div class="checkbox">
                    ...
                    <label for="checkbox1"> ریمکس </label>
                  </div>
                  <div class="checkbox">
                    <input id="checkbox2" type="checkbox" />
                    <label for="checkbox2"> باسئوس </label>
                  </div>
                  <div class="checkbox">
                    <input id="checkbox3" type="checkbox" />
                    <label for="checkbox3"> اپل </label>
                  </div>
                  <div class="checkbox">
                    <input id="checkbox4" type="checkbox" />
                    <label for="checkbox4"> نیلکین </label>
                  </div>
                  <div class="checkbox">
                    <input id="checkbox5" type="checkbox" />
                    <label for="checkbox5"> راک </label>
                  </div>
                  <div class="checkbox">
                    <input id="checkbox6" type="checkbox" />
                    <label for="checkbox6"> توتو </label>
                  </div>
                  <div class="checkbox">
                    <input id="checkbox7" type="checkbox" />
                    <label for="checkbox7"> فراری </label>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="collapse show" id="collapseExample2">
                ...
                <div class="filter-option">
                  <div class="checkbox">
                    ...
                    <label for="checkbox8"> ریمکس </label>
                  </div>
                  <div class="checkbox">
                    <input id="checkbox9" type="checkbox" />
                    <label for="checkbox9"> باسئوس </label>
                  </div>
                  <div class="checkbox">
                    <input id="checkbox10" type="checkbox" />
                    <label for="checkbox10"> اپل </label>
                  </div>
                  <div class="checkbox">
                    <input id="checkbox11" type="checkbox" />
                    <label for="checkbox11"> نیلکین </label>
                  </div>
                  <div class="checkbox">
                    <input id="checkbox12" type="checkbox" />
                    <label for="checkbox12"> راک </label>
                  </div>
                  <div class="checkbox">
                    <input id="checkbox13" type="checkbox" />
                    <label for="checkbox13"> توتو </label>
                  </div>
                  <div class="checkbox">
                    <input id="checkbox14" type="checkbox" />
                    <label for="checkbox14"> فراری </label>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="box-content">
              ...
              >
                <div
                  ...
                  style="width: 122px; margin-left: 0px"
                >
                  <span
                    class="bootstrap-switch-handle-on bootstrap-switch-primary"
                    style="width: 50px"
                  ></span
                  ><span class="bootstrap-switch-label" style="width: 26px"
                    >&nbsp;</span
                  ><span
        ...
        <div class="col-12 col-sm-12 col-md-8 col-lg-9 order-2">
          ...
          <div class="listing default">
            ...
            <div class="listing-header default">
              <ul
                class="listing-sort nav nav-tabs justify-content-center"
                role="tablist"
                    ...
                    <li class="col-xl-3 col-lg-4 col-md-6 col-12 no-padding">
                      <div class="product-box">
                        ...
                        >
                          ...
                          >
                          <span
                            class="product-seller-details-badge-container"
                          ></span>
                        </div>
